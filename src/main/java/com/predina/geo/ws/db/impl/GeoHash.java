...
public final class GeoHash {
     ...
     */
    public static final int MAX_HASH_LENGTH = 28;

    /**
     * Default maximum number of hashes for covering a bounding box.
     */
    public static final int DEFAULT_MAX_HASHES = 28;
    ...
    public static String encodeHash(double latitude, double longitude, int length) {
        Preconditions.checkArgument(length > 0 && length <= DEFAULT_MAX_HASHES, "length must be between 1 and "+DEFAULT_MAX_HASHES);
    ...
    static String fromLongToString(long hash) {
        ...
        if (length > DEFAULT_MAX_HASHES || length < 1)
